...
const UserPannel = ({user, userPanelVisible, setUserPanelVisible}: any) => {
        ...
        <div className="offcanvas-content pr-5 mr-n5">
          ...
          <div className="d-flex align-items-center mt-5">
            ...
            <div className="d-flex flex-column">
              ...
              <div className="text-muted mt-1">{user?.roles && user.roles.map((item:any)=>item.name).join(", ")}</div>
              <div className="navi mt-2">
                <span className="navi-item">
                  <span className="navi-link p-0 pb-2">
               
                    <span className="navi-text text-muted text-hover-primary">
                    <i className="flaticon2-user mr-2"></i>
                    {user?.user_name}
                    </span>
                  </span>
                </span>
          ...
          <div className="navi navi-spacer-x-0 p-0">
            {/*<!--begin::Item-->*/}
            <Link href="/user/me" className="navi-item">
            ...
            {/*<!--end:Item-->*/}
            {/*<!--begin::Item-->*/}
            <Link href="custom/apps/user/profile-3.html" className="navi-item">
              <div className="navi-link">
                <div className="symbol symbol-40 bg-light mr-3">
                  <div className="symbol-label">
            ...
            {/*<!--end:Item-->*/}
            {/*<!--begin::Item-->*/}
            <Link href="custom/apps/user/profile-2.html" className="navi-item">
              <div className="navi-link">
                <div className="symbol symbol-40 bg-light mr-3">
                  <div className="symbol-label">
