...
const ButtonEditAtoms = (props: any) => {
    const { slug, page } = props

    return (
        <Link href={`${page || 'income-and-expenditure-category'}/edit/${slug}`}>
            <a>
            <div className="btn btn-icon btn-light-primary btn-circle btn-sm">
...
export default ButtonEditAtoms